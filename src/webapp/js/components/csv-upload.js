...
import { hasAuthority, UPLOAD_CHW_OR_INCHARGE_CSV_AUTHORITY, UPLOAD_LOCATION_CSV_AUTHORITY } from '../utils/authorization';
...
class CsvUpload extends Component {
  ...
  componentWillMount() {
    if (!hasAuthority(UPLOAD_CHW_OR_INCHARGE_CSV_AUTHORITY, UPLOAD_LOCATION_CSV_AUTHORITY)) {
