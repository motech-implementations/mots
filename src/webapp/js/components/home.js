...
const Home = () => (
  <div>
    ...
    <h4> As in many African countries, the Community Health Worker (CHW) is
      ...
      outbreak response.  The project will set up a MOTS service that is the
      vehicle for delivery of this training. This service will provide mobile
      training to CHWs via their mobile phones with feature phone as the basic
      requirement. The MOTS service will provide training modules that include
      units and quizzes, and allow monitoring by management.
    </h4>
  </div>
);
