...
import org.motechproject.mots.validate.constraintvalidators.DistrictExistenceValidator;

@Target(ElementType.FIELD)
@Constraint(validatedBy = {DistrictExistenceValidator.class})
@Retention(RetentionPolicy.RUNTIME)
public @interface DistrictExistence {
   ...
   */
  String message() default ValidationMessageConstants.NOT_EXISTING_DISTRICT;
