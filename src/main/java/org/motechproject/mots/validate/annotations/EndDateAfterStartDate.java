...
import org.motechproject.mots.validate.constraintvalidators.DistrictAssignmentDtoEndDateAfterStartDateValidator;

@Target(ElementType.TYPE)
@Constraint(validatedBy = DistrictAssignmentDtoEndDateAfterStartDateValidator.class)
