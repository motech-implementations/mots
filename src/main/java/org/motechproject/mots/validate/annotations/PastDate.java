...
import org.motechproject.mots.validate.constraintvalidators.PastDateFormatValidator;

@Target(ElementType.FIELD)
@Constraint(validatedBy = {PastDateFormatValidator.class})
...
public @interface PastDate {
   ...
   */
  String message() default ValidationMessageConstants.INVALID_PAST_DATE;
