...
import org.motechproject.mots.validate.constraintvalidators.incharge.InchargeEmailValidator;

@Target(ElementType.TYPE)
@Constraint(validatedBy = {InchargeEmailValidator.class})
@Retention(RetentionPolicy.RUNTIME)
public @interface InchargeEmailUniqueness {
   ...
   */
  String message() default ValidationMessages.INCHARGE_DUPLICATE_EMAIL;
