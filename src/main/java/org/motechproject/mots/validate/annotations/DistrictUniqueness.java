...
import org.motechproject.mots.validate.constraintvalidators.DistrictUniquenessValidator;

@Target(ElementType.TYPE)
@Constraint(validatedBy = {DistrictUniquenessValidator.class})
@Retention(RetentionPolicy.RUNTIME)
public @interface DistrictUniqueness {
   ...
   */
  String message() default ValidationMessageConstants.NOT_UNIQUE_DISTRICT;
