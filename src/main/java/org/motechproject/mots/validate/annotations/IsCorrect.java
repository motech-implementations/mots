...
import org.motechproject.mots.validate.constraintvalidators.IsCorrectValidator;

@Target(ElementType.FIELD)
@Constraint(validatedBy = {IsCorrectValidator.class})
...
public @interface IsCorrect {
   ...
   */
  String message() default ValidationMessageConstants.ONE_CHOICE_CORRECT;
