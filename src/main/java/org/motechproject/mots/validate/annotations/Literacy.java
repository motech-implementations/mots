...
import org.motechproject.mots.validate.constraintvalidators.LiteracyValidator;

@Target(ElementType.FIELD)
@Constraint(validatedBy = {LiteracyValidator.class})
...
public @interface Literacy {
   ...
   */
  String message() default ValidationMessages.INVALID_LITERACY;
