...
import org.motechproject.mots.validate.constraintvalidators.user.UsernameValidator;
...
public @interface UsernameUniqueness {
   ...
   */
  String message() default ValidationMessageConstants.NOT_UNIQUE_USERNAME;
