...
VALUES ('70638cc4-4c33-4899-8480-a4ef1607273b', '2018-05-08 16:07:22.745000', '2018-05-08 16:07:22.745000', 'Voto', 'https://go.votomobile.org/api/v1', '410893', true, '3824182', 1, 3, 60, 15, false, 'incoming_call_id', 'outgoing_call_id', 'subscriber_id', 'delivery_log_id', 'delivery_status');

INSERT INTO `mots`.`ivr_config_languages` (`ivr_config_id`, `ivr_language_id`, `language`) VALUES ('70638cc4-4c33-4899-8480-a4ef1607273b', '209488', 'ENGLISH');
INSERT INTO `mots`.`ivr_config_languages` (`ivr_config_id`, `ivr_language_id`, `language`) VALUES ('70638cc4-4c33-4899-8480-a4ef1607273b', '209487', 'KINYARWANDA');
